        ...
        <div class="card-style-3 mb-30">
            <div class="card-content">
                <div class="table-wrapper table-responsive">
                    <table class="table striped-table" id="dataTableCity">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th><h6>Nama Kota</h6></th>
                            <th><h6>Provinsi</h6></th>
                            <th><h6>Aksi</h6></th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($cities as $city)
                            <tr>
                                ...
                                <td><p>{{ $city->name }}</p></td>
                                <td><p>{{ $city->province->name }}</p></td>
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('cities.show', $city) }}" class="btn btn-sm btn-info me-1" title="Lihat">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('cities.edit', $city) }}" class="btn btn-sm btn-warning me-1" title="Ubah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('cities.index') }}" method="GET">
                    <div class="modal-header">
                        <h5 class="modal-title">Filter Kota</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text">Cari berdasarkan nama kota</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>

        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="title mb-30">
                    <h2>{{ __('Pengelolaan Kategori Produk') }}</h2>
                </div>
            </div>
                    ...
                    <table class="table striped-table" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('product-category.show', $category) }}" class="btn btn-sm btn-info me-1" title="Lihat">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('product-category.edit', $category) }}" class="btn btn-sm btn-warning me-1" title="Ubah">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ route('product-category.destroy', $category) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="modal-content">
                <form action="{{ route('product-category.store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Kategori Produk Baru</h5>
                ...
                <form action="{{ route('product-category.index') }}" method="GET">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <small class="form-text">Cari berdasarkan nama atau deskripsi kategori</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
